...
function ENT:Initialize( )
	...
	if phys and phys:IsValid( ) then
		...
		phys:AddAngleVelocity( Vector( math.random( -100 , 100 ), math.random( -100 , 100 ), math.random( -500 , 500 ) ) )
		phys:SetDragCoefficient( GetConVarNumber("sw_meteor_drag") )
...
function ENT:PhysicsCollide( data, phys )
	...
	if self:GetDieTime( ) <= 0 and GetConVarNumber("sw_meteor_lifetime") > -1 and GetConVarNumber("sw_meteor_fancyfx") == 1 then
		...
		MeteorFXExplosion:SetKeyValue( "imagnitude" , "512" )
		MeteorFXExplosion:SetKeyValue( "spawnflags" , "5061" )
		...
		physboom:SetKeyValue( "magnitude" , "512" )
